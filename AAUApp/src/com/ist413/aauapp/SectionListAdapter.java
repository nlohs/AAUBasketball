...
public class SectionListAdapter extends BaseExpandableListAdapter {
    ...
    public SectionListAdapter(Context context, List<MenuSection> sections) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        textView.setText(((MenuSection) getGroup(groupPosition)).getTitle());
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.menu_sectionitem,
                    parent, false);
        }

        MenuListItem oSectionItem = this.sections.get(groupPosition).getSectionItems().get(childPosition);
